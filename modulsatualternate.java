...
public class modulsatualternate {
    ...
    class Buku {
        ...
        void simpanFile(String namaFile) {
            ...
            try {
                ...
                System.out.println("Penyimpanan data ke file sukses");

            } catch (Exception e) {
                System.out.println("Penyimpanan data ke file tidak sukses");
            }
        }
    ...
    public static void main(String[] args) {
        ...
        //SIMPAN FILE
        b1.simpanFile("dataBuku.txt");

        //BACA FILE
        Buku bukuBaru = p.new Buku("", 0, "", teknologi);

        bukuBaru.bacaFile("dataBuku.txt");
